...
impl State {
    ...
    fn dead(&mut self, ctx: &mut BTerm) {
        ctx.cls();
        ctx.print_centered(8, "You are dead !!");
        ctx.print_centered(9, &format!("You passed {} obstacles", self.score));
    ...
    fn main_menu(&mut self, ctx: &mut BTerm) {
        ctx.cls();
        ctx.print_centered(8, "Welcome to Flappy Dragons !");
        ctx.print_centered(10, "(P) Play");
